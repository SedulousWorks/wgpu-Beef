...
static
{
	...
	[CLink] public static extern uint32 wgpuGetVersion(void);
	...
	[CLink] public static extern void wgpuRenderPassEncoderSetImmediates(WGPURenderPassEncoder encoder, uint32 offset, uint32 sizeBytes, void* data);
	[CLink] public static extern void wgpuComputePassEncoderSetImmediates(WGPUComputePassEncoder encoder, uint32 offset, uint32 sizeBytes, void* data);
	[CLink] public static extern void wgpuRenderBundleEncoderSetImmediates(WGPURenderBundleEncoder encoder, uint32 offset, uint32 sizeBytes, void* data);
